  ...
  return (
    <div>
      <section className="contacts">
        ...
        <ul>
          <li>
            <a href="tel:0706691762" className="icons">
              +46 7 06 69 17 62
          ...
          <li>
            <a href="mailto:pradetelodie@gmail.com" className="icons">
              pradetelodie@gmail.com <FaEnvelope className="icons" />
            </a>
          </li>
        </ul>
        <div className="image-rsp">
          <div className="desk">
            <img src={desk} alt="desktop computer and plant" />
          </div>

          <div className="contactcoffee">
            <img src={contactcoffee} alt="coffee cup" />
          </div>
        </div>

        <p className="prefer">
          Prefering{" "}
          <button onClick={scrollToContactForm}>a contact form </button>{" "}
          instead?{" "}
        </p>
      </section>
